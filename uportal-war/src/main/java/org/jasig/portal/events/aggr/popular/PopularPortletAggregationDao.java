...
public interface PopularPortletAggregationDao<T extends PopularPortletAggregation> {
    ...
    /**
     * Portlet added to layout aggregations in a date range for a specified interval and group
     */
     ...
     */
    Set<T> getPopularPortletAggregationsForInterval(DateDimension dateDimension, TimeDimension timeDimension, AggregationInterval interval);
    
    PopularPortletAggregation getPopularPortletAggregation(DateDimension dateDimension, TimeDimension timeDimension, AggregationInterval interval, AggregatedGroupMapping aggregatedGroup);
}