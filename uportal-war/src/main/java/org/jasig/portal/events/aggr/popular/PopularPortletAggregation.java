...
public interface PopularPortletAggregation extends BaseAggregation {
    ...
    /**
     * @return Total number of {@link PortletAddedToLayoutEvent}s that occurred in the interval
     */
    int getAddCount();
    
    /**
     * @return Unique number of {@link PortletAddedToLayoutEvent}s that occurred in the interval, uniqueness is determined by {@link PortletAddedToLayoutEvent#getFName()}
     */
